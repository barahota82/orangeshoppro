...
function orange_gl_setting_key_labels(): array
{
    return [
        ...
        'ar_cash' => 'عملاء نقدي — وسيط تسليم المبيعات النقدية (تسجيل على العملاء النقدي ثم التحصيل من الخزينة)',
        'ar_online' => 'عملاء أونلاين — وسيط تسليم مبيعات أونلاين (نفس منطق النقدي: وسيط ثم الخزينة)',
