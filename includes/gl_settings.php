...
function orange_gl_setting_row_short_labels(): array
{
    return [
        ...
        'cogs_cash' => 'تكلفة المبيعات',
        'sales_returns_cash' => 'مردود المبيعات',
        'cogs_returns_cash' => 'تكلفة مردود المبيعات',
        'sales_revenue_credit' => 'المبيعات الآجل',
        'cogs_credit' => 'تكلفة المبيعات',
        'sales_returns_credit' => 'مردود المبيعات',
        'cogs_returns_credit' => 'تكلفة مردود المبيعات',
        'sales_revenue_online' => 'المبيعات الاونلاين',
        'cogs_online' => 'تكلفة المبيعات',
        'sales_returns_online' => 'مردود المبيعات',
        'cogs_returns_online' => 'تكلفة مردود المبيعات',
    ];
}
