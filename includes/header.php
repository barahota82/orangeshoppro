...
<head>
    ...
    <script>
        ...
        window.APP_T = {
            ...
            cart_gift_pick_max_hint: <?php echo json_encode(t('cart_gift_pick_max_hint'), JSON_UNESCAPED_UNICODE); ?>,
            cart_gift_accept: <?php echo json_encode(t('cart_gift_accept'), JSON_UNESCAPED_UNICODE); ?>,
            cart_gift_decline: <?php echo json_encode(t('cart_gift_decline'), JSON_UNESCAPED_UNICODE); ?>,
            cart_gift_product_details: <?php echo json_encode(t('cart_gift_product_details'), JSON_UNESCAPED_UNICODE); ?>,
            cart_gift_variant_label: <?php echo json_encode(t('cart_gift_variant_label'), JSON_UNESCAPED_UNICODE); ?>,
            cart_gift_price_free: <?php echo json_encode(t('cart_gift_price_free'), JSON_UNESCAPED_UNICODE); ?>,
