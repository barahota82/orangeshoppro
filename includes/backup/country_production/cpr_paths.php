...
const ORANGE_CPR_SCAFFOLD_VERSION = 'P9-02-enablement-preconditions';
...
const ORANGE_CPR_ENABLEMENT_DIRNAME = 'enablement';
...
function orange_cpr_special_live_directory(string $cprRoot, string $jobId): string
{
    return orange_cpr_job_directory($cprRoot, $jobId) . DIRECTORY_SEPARATOR . ORANGE_CPR_SPECIAL_LIVE_DIRNAME;
}
...
function orange_cpr_success_finalize_directory(string $cprRoot, string $jobId): string
{
    return orange_cpr_job_directory($cprRoot, $jobId) . DIRECTORY_SEPARATOR . ORANGE_CPR_SUCCESS_FINALIZE_DIRNAME;
}

function orange_cpr_rollback_directory(string $cprRoot, string $jobId): string
{
    return orange_cpr_job_directory($cprRoot, $jobId) . DIRECTORY_SEPARATOR . ORANGE_CPR_ROLLBACK_DIRNAME;
}
...
function orange_cpr_drill_execution_directory(string $cprRoot, string $jobId): string
{
    return orange_cpr_job_directory($cprRoot, $jobId) . DIRECTORY_SEPARATOR . ORANGE_CPR_DRILL_EXECUTION_DIRNAME;
}

function orange_cpr_evidence_pack_directory(string $cprRoot, string $jobId): string
{
    return orange_cpr_job_directory($cprRoot, $jobId) . DIRECTORY_SEPARATOR . ORANGE_CPR_EVIDENCE_PACK_DIRNAME;
}
...
function orange_cpr_enablement_directory(string $cprRoot, string $jobId): string
{
    return orange_cpr_job_directory($cprRoot, $jobId) . DIRECTORY_SEPARATOR . ORANGE_CPR_ENABLEMENT_DIRNAME;
}
