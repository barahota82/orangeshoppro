...
/** Status Refresh / list hydration must not scan the package dump; diagnostic owns the scan. */
const ORANGE_RESTORE_STEP7_SQL_PACKAGE_SCAN_DEFERRED_FROM_STATUS_REFRESH = 'STEP7_SQL_PACKAGE_SCAN_DEFERRED_FROM_STATUS_REFRESH';
const ORANGE_RESTORE_SQL_PKG_SCAN_DEFERRED = 'SQL_PACKAGE_SCAN_DEFERRED_FROM_STATUS_REFRESH';
