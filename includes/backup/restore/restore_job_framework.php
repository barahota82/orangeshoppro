...
const ORANGE_RESTORE_FW_STATUS_SHADOW_RESTORE_PENDING = 'shadow_restore_pending';
const ORANGE_RESTORE_FW_STATUS_SHADOW_RESTORE_RUNNING = 'shadow_restore_running';
const ORANGE_RESTORE_FW_STATUS_SHADOW_RESTORE_VERIFYING = 'shadow_restore_verifying';
const ORANGE_RESTORE_FW_STATUS_SHADOW_RESTORE_READY = 'shadow_restore_ready';
const ORANGE_RESTORE_FW_STATUS_SHADOW_RESTORE_FAILED = 'shadow_restore_failed';
...
const ORANGE_RESTORE_FW_STATUS_ROLLBACK_PENDING = 'rollback_pending';
const ORANGE_RESTORE_FW_STATUS_ROLLBACK_DATABASE_RUNNING = 'rollback_database_running';
const ORANGE_RESTORE_FW_STATUS_ROLLBACK_DATABASE_VERIFYING = 'rollback_database_verifying';
const ORANGE_RESTORE_FW_STATUS_ROLLBACK_FILES_RUNNING = 'rollback_files_running';
...
const ORANGE_RESTORE_FW_PHASE_SHADOW_RESTORE_PENDING = 'shadow_restore_pending';
const ORANGE_RESTORE_FW_PHASE_SHADOW_RESTORE_RUNNING = 'shadow_restore_running';
const ORANGE_RESTORE_FW_PHASE_SHADOW_RESTORE_VERIFYING = 'shadow_restore_verifying';
const ORANGE_RESTORE_FW_PHASE_SHADOW_RESTORE_READY = 'shadow_restore_ready';
const ORANGE_RESTORE_FW_PHASE_SHADOW_RESTORE_FAILED = 'shadow_restore_failed';
...
const ORANGE_RESTORE_FW_PHASE_ROLLBACK_PENDING = 'rollback_pending';
const ORANGE_RESTORE_FW_PHASE_ROLLBACK_DATABASE_RUNNING = 'rollback_database_running';
const ORANGE_RESTORE_FW_PHASE_ROLLBACK_DATABASE_VERIFYING = 'rollback_database_verifying';
const ORANGE_RESTORE_FW_PHASE_ROLLBACK_FILES_RUNNING = 'rollback_files_running';
...
function orange_restore_fw_public_row(array $job): array
{
    ...
    return [
        ...
        'rollback_requestable' => $status === ORANGE_RESTORE_FW_STATUS_UPLOADS_CUTOVER_READY
            && (string) ($job['package_type'] ?? '') === 'full_disaster',
        'has_rollback' => in_array($status, [
            ORANGE_RESTORE_FW_STATUS_ROLLBACK_PENDING,
            ORANGE_RESTORE_FW_STATUS_ROLLBACK_DATABASE_RUNNING,
            ORANGE_RESTORE_FW_STATUS_ROLLBACK_DATABASE_VERIFYING,
            ORANGE_RESTORE_FW_STATUS_ROLLBACK_FILES_RUNNING,
        ...
        'has_shadow_verification' => !empty($job['shadow_verification_file'])
            || in_array($status, [
                ORANGE_RESTORE_FW_STATUS_SHADOW_VERIFYING,
                ORANGE_RESTORE_FW_STATUS_SHADOW_VERIFIED,
                ORANGE_RESTORE_FW_STATUS_SHADOW_NOT_READY,
