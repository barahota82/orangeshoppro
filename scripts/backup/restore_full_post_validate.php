...
/**
 * DISABLED tombstone -- Phase-2 post-cutover validation CLI (P0-2 / F-ARCH-01 / F-CLI-02).
 *
 * Reason: legacy_restore_entrypoint_disabled
 * Post-cutover steps belong to the approved 3B.4 lifecycle (not this entrypoint).
 *
 * Library retained: orange_restore_orchestrator_post_validation
