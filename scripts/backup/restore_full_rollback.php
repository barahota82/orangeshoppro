...
/**
 * DISABLED tombstone -- Phase-2 production rollback CLI (P0-2 / F-ARCH-01 / F-CLI-02).
 *
 * Reason: legacy_restore_entrypoint_disabled
 * Use approved 3B.4 worker: scripts/backup/restore_rollback.php --job=JOB_ID
 *
 * Library retained: orange_restore_orchestrator_rollback
