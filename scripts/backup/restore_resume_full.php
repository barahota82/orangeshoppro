...
/**
 * DISABLED tombstone -- Phase-2 Full E2E resume CLI (P0-2 / F-ARCH-01 / F-CLI-02).
 *
 * Reason: legacy_restore_entrypoint_disabled
 * Use approved 3B.4 job-scoped workers only (--job=; no argv credentials).
 *
 * Library retained for isolated tests: orange_restore_e2e_resume_full
