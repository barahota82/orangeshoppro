...
try {
    cpr_osub('scaffold_version', ORANGE_CPR_SCAFFOLD_VERSION === 'P8-02-owner-submission');
    ...
    cpr_osub('index_stop_blocks_p8_03', str_contains($index, 'Do **not** begin **WP-P8-03**'));
