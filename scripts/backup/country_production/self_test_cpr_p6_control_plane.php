...
try {
    cpr_p6cp('scaffold_version', ORANGE_CPR_SCAFFOLD_VERSION === 'P6-01-control-plane');
    ...
    cpr_p6cp('no_post_verify_engine_yet', empty($snap['post_verify_engine_implemented']));
    cpr_p6cp('no_success_finalize_yet', empty($snap['success_finalize_engine_implemented']));
    ...
    cpr_p6cp('index_stop_blocks_p6_02', str_contains($index, 'Do **not** begin **WP-P6-02**'));
