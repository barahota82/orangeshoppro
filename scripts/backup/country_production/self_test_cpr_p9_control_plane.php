...
/**
 * Self-test: CPR P9 Control Plane (WP-P9-01; flags updated through WP-P9-03).
...
try {
    cpr_p9cp('scaffold_version', ORANGE_CPR_SCAFFOLD_VERSION === 'P9-03-enablement-actions');
    ...
    cpr_p9cp('index_lists_action_module', str_contains($index, 'cpr_enablement_action_live.php'));
    cpr_p9cp('index_stop_blocks_wp04', str_contains($index, 'Do **not** begin **WP-P9-04**'));
    cpr_p9cp(
        'design_doc_exists',
