...
/**
 * Self-test: CPR P9 Control Plane (WP-P9-01; flags updated through WP-P9-02).
...
try {
    cpr_p9cp('scaffold_version', ORANGE_CPR_SCAFFOLD_VERSION === 'P9-02-enablement-preconditions');
    ...
    cpr_p9cp('index_lists_preconditions_module', str_contains($index, 'cpr_enablement_preconditions_live.php'));
    cpr_p9cp('index_stop_blocks_wp03', str_contains($index, 'Do **not** begin **WP-P9-03**'));
    ...
    cpr_p9cp(
        'design_doc_exists',
        is_file($docsRoot . DIRECTORY_SEPARATOR . 'COUNTRY_PRODUCTION_RESTORE_P9_02_ENABLEMENT_PRECONDITIONS.md')
    );
} catch (Throwable $e) {
