...
try {
    cpr_p5cp('scaffold_version', ORANGE_CPR_SCAFFOLD_VERSION === 'P5-01-control-plane');
    ...
    cpr_p5cp('no_delete_engine_yet', empty($snap['production_delete_engine_implemented']));
    ...
    cpr_p5cp('index_stop_blocks_p5_02', str_contains($index, 'Do **not** begin **WP-P5-02**'));
