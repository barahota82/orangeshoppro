...
try {
    cpr_p5cp('scaffold_version', ORANGE_CPR_SCAFFOLD_VERSION === 'P5-02-delete-live');
    ...
    cpr_p5cp('no_import_engine_yet', empty($snap['production_import_engine_implemented']));
    ...
    cpr_p5cp('index_lists_wp_p5_02', str_contains($index, 'WP-P5-02'));
    cpr_p5cp('index_wp_p5_02_complete', str_contains($index, 'WP-P5-02') && str_contains($index, 'COMPLETE'));
    cpr_p5cp('index_stop_blocks_p5_03', str_contains($index, 'Do **not** begin **WP-P5-03**'));
