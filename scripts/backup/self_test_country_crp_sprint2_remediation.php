...
function s2_seed_schema(PDO $pdo, string $db): void
{
    ...
    $pdo->exec('CREATE TABLE admin_permissions (admin_id INT NOT NULL, resource_key VARCHAR(80) NOT NULL, PRIMARY KEY (admin_id, resource_key))');
    ...
    $pdo->exec('CREATE TABLE inventory_cost_layers (id INT PRIMARY KEY, warehouse_id INT NULL, qty_in INT NOT NULL DEFAULT 0, qty_remaining INT NOT NULL DEFAULT 0, country_id INT NULL)');
    $pdo->exec('CREATE TABLE inventory_cost_consumptions (id INT PRIMARY KEY, layer_id INT NOT NULL, consumed_qty INT NOT NULL DEFAULT 0)');
    ...
    $pdo->exec('CREATE TABLE document_sequences (scope VARCHAR(64) NOT NULL, `last_value` BIGINT NOT NULL DEFAULT 0, updated_at TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (scope))');
...
function s2_seed_rows(PDO $pdo): void
{
    ...
    $pdo->exec("INSERT INTO admin_permissions (admin_id, resource_key) VALUES (1,'orders')");
    ...
    $pdo->exec('INSERT INTO inventory_cost_layers (id, warehouse_id, qty_in, qty_remaining, country_id) VALUES (1,1,5,5,1)');
    $pdo->exec('INSERT INTO inventory_cost_consumptions (id, layer_id, consumed_qty) VALUES (1,1,1)');
    ...
    $pdo->exec("INSERT INTO document_sequences (scope, `last_value`) VALUES ('inv_c1',5)");
    ...
    $pdo->exec("INSERT INTO admin_permissions (admin_id, resource_key) VALUES (2,'orders')");
    ...
    $pdo->exec("INSERT INTO document_sequences (scope, `last_value`) VALUES ('inv_c2',9)");
    // Global
