...
CREATE TABLE `suppliers` (
  ...
  `email` varchar(255) DEFAULT NULL,
  `commercial_reg` varchar(64) DEFAULT NULL,
  `address_line` varchar(255) DEFAULT NULL,
  `city_area` varchar(160) DEFAULT NULL,
  `opening_balance` decimal(18,4) DEFAULT NULL,
  `credit_limit` decimal(18,4) DEFAULT NULL,
  `bank_name` varchar(160) DEFAULT NULL,
  `bank_iban` varchar(64) DEFAULT NULL,
  `bank_account_holder` varchar(160) DEFAULT NULL,
  `preferred_warehouse_id` int DEFAULT NULL,
