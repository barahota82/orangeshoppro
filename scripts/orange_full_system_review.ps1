...
$adminScreens = @(
    ...
    @{ Page = 'gl_posting'; Area = 'GL'; Scope = 'country'; PolicyRef = 'GL-MOVEMENTS'; Status = 'OK'; Notes = 'Pending posting queue' },
    ...
    @{ Page = 'accounting_reports_index'; Area = 'GLReports'; Scope = 'global'; PolicyRef = 'admin-screens'; Status = 'OK'; Notes = 'Link index only' },
