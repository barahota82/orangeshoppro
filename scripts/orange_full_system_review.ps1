...
$adminScreens = @(
    ...
    @{ Page = 'inventory_reconciliation'; Area = 'Warehouse'; Scope = 'country'; PolicyRef = 'admin-screens'; Status = 'OK'; Notes = 'report/count only' },
    @{ Page = 'stock_adjustment_voucher'; Area = 'Warehouse'; Scope = 'country'; PolicyRef = 'admin-screens'; Status = 'OK'; Notes = 'applies stock + GL per line' },
