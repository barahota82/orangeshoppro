...
| WP-P1-09 | CPR-P1-WP09-FAIL_RESUME_ROLLBACK | `COUNTRY_PRODUCTION_RESTORE_P1_09_FAIL_RESUME_ROLLBACK.md` | **COMPLETE** |
| WP-P1-10 | CPR-P1-WP10-UPLOADS_CONTRACT | `COUNTRY_PRODUCTION_RESTORE_P1_10_UPLOADS_CONTRACT.md` | **COMPLETE** |
...
| 1.8 | 2026-07-21 | WP-P1-09 marked COMPLETE in inventory (§7) |
| 1.9 | 2026-07-21 | WP-P1-10 marked COMPLETE in inventory (§7) |
