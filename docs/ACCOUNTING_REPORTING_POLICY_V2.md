...
- **Empty COA (no posting leaves yet):** Income statement, trading account, monthly and year-compare P&amp;L screens, **and trial balance**, must still render the chrome (title, filters) and a visible in-app notice — not a blank main area — while the ledger has no posting-leaf rows to classify.
