...
- **تخطيط النموذج** صار صفّين × 3 أعمدة (`.asg-form-grid`، RTL فالحقل الأول يميناً): السطر الأول **القسم الرئيسي\* · نوع المقاس (تصفية)\* · عائلة المقاسات\***؛ السطر الثاني **الاسم الداخلي (عربي)\* · شكل الدليل\* · الحالة**.
