...
- **تخطيط النموذج** شبكة **7 أعمدة** (`.asg-form-grid` عبر `grid-template-areas`، RTL فالعمود الأول يميناً) بامتدادات حدّدها المالك (2026-06-23): السطر الأول **القسم الرئيسي\* (2) · نوع المقاس (تصفية)\* (2) · عائلة المقاسات\* (2) · الحالة (1)**؛ السطر الثاني **الاسم الداخلي (عربي)\* (4) · شكل الدليل\* (3)** — أي `"dept dept kind kind family family status" / "name name name name shape shape shape"`. الشبكة `width: 100%` (تملأ كامل عرض الكارت فلا يبقى فراغ أبيض بعد «الحالة»؛ هامش متساوٍ يميناً ويساراً — قرار المالك 2026-06-23).
