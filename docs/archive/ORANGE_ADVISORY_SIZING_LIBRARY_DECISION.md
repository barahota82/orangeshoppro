...
- **تخطيط النموذج** (`.asg-form-grid` شبكة **8 أعمدة** عبر `grid-template-areas`، RTL فالعمود الأول يميناً) — مواصفات المالك (2026-06-23): السطر الأول يملأ 7 أعمدة **القسم الرئيسي\*(عمودان) · نوع المقاس (تصفية)\*(عمودان) · عائلة المقاسات\*(عمودان) · الحالة(عمود واحد)** ثم عمود فارغ؛ السطر الثاني **الاسم الداخلي (عربي)\*(4 أعمدة، يميناً)** و**شكل الدليل\*(4 أعمدة، أقصى اليسار)**. الحالة عمود واحد = **نصف عرض** الخانات الثلاث (عمودان لكلٍّ). `max-width: 1340px` كي تبقى الخانات الثلاث ≈ عرضها السابق (~321px).
