...
- **تخطيط النموذج** (`.asg-form-grid` عبر `grid-template-areas`، RTL فالعمود الأول يميناً): السطر الأول **القسم الرئيسي\* · نوع المقاس (تصفية)\* · عائلة المقاسات\* · الحالة** — والحالة عمود **نصف العرض** (`0.5fr`)؛ السطر الثاني **الاسم الداخلي (عربي)\*** يميناً و**شكل الدليل\*** في **أقصى اليسار** (`"name . shape shape"`). `max-width: 1180px` كي تبقى الخانات الثلاث بعرضها تقريباً (≈321px) دون تقليص (قرار المالك 2026-06-23: رفع «الحالة» للسطر الأول بنصف عرض، وشكل الدليل أقصى يسار السطر الثاني، دون تغيير عرض الخانات الثلاث).
