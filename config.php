...
function get_translations(): array {
    return [
        'en' => [
            ...
            'register_placeholder_phone' => 'National number only (pick country from the list first)',
            ...
            'phone_country_label' => 'Country (dropdown)',
            'phone_number_label' => 'Number',
            ...
            'phone_field_hint' => 'Pick country in the list, then type national digits (no +). Or choose «International» and type the full number with + or 00.',
        ...
        'ar' => [
            ...
            'register_placeholder_phone' => 'الرقم الوطني فقط (بعد اختيار الدولة من القائمة)',
            ...
            'phone_country_label' => 'الدولة (قائمة منسدلة)',
            ...
            'phone_field_hint' => 'اختر الدولة من القائمة ثم أدخل الرقم الوطني (بدون +). أو «دولي» ثم الرقم كاملاً بـ + أو 00.',
        ...
        'fil' => [
            ...
            'register_placeholder_phone' => 'Pambansang numero (pumili muna ng bansa sa listahan)',
            ...
            'phone_country_label' => 'Bansa (dropdown)',
            'phone_number_label' => 'Numero',
            'phone_country_full_international' => 'International — buong numero na may + o 00',
            'phone_country_kw' => 'Kuwait +965 (8 digit mobile)',
            'phone_country_ph' => 'Pilipinas +63',
            'phone_country_in' => 'India +91',
            'phone_country_pk' => 'Pakistan +92',
            'phone_field_hint' => 'Pumili ng bansa sa listahan, pagkatapos ilagay ang pambansang digit (walang +). O «International» at buong numero na may + o 00.',
            'customer_email' => 'Email',
            'order_number' => 'Order Number',
        ...
        'hi' => [
            ...
            'register_placeholder_phone' => 'केवल राष्ट्रीय नंबर (पहले सूची से देश चुनें)',
            ...
            'phone_country_label' => 'देश (ड्रॉपडाउन)',
            'phone_number_label' => 'नंबर',
            ...
            'phone_field_hint' => 'सूची से देश चुनें, फिर राष्ट्रीय अंक (+ के बिना)। या «अंतर्राष्ट्रीय» और + या 00 के साथ पूरा नंबर।',
            'customer_email' => 'ईमेल',
