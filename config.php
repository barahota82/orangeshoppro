...
function get_translations(): array {
    return [
        'en' => [
            ...
            'track_form_section_title' => 'Order lookup',
            'track_signup_cta_title' => 'Optional email sign-up',
            'track_signup_cta_text' => 'Register with your email to confirm your address and stay in touch with the store — buying as a guest stays available.',
        ...
        'ar' => [
            ...
            'track_form_section_title' => 'متابعة الطلب',
            'track_signup_cta_title' => 'سجّل بريدك (اختياري)',
            'track_signup_cta_text' => 'سجّل بريدك لتأكيده والبقاء على تواصل مع المتجر — الشراء كضيف يبقى متاحاً كما هو.',
        ...
        'fil' => [
            ...
            'track_form_section_title' => 'Hanapin ang order',
            'track_signup_cta_title' => 'Opsyonal: email sign-up',
            'track_signup_cta_text' => 'Mag-register gamit ang email para kumpirmahin at manatiling konektado sa tindahan — puwede pa ring guest checkout.',
        ...
        'hi' => [
            ...
            'track_form_section_title' => 'ऑर्डर खोजें',
            'track_signup_cta_title' => 'वैकल्पिक: ईमेल से साइन अप',
            'track_signup_cta_text' => 'अपना ईमेल पंजीकृत करके पुष्टि करें और स्टोर से जुड़े रहें — अतिथि चेकआउट पहले जैसा रहेगा।',
