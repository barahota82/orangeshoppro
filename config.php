...
function get_translations(): array {
    return [
        'en' => [
            ...
            'track_identity_explain' => 'Below you can view your order status only. To register your email and update your details, use the sign-up box above and enter your order number and phone there.',
            'track_signup_identity_note' => 'Enter your order number and the phone on that order here. They must match our records or the email request will be rejected.',
        ...
        'ar' => [
            ...
            'track_identity_explain' => 'القسم أدناه لمتابعة حالة الطلب فقط. لتسجيل البريد وتحديث بياناتك استخدم صندوق التسجيل أعلاه وأدخل رقم الطلب والهاتف هناك.',
            'track_signup_identity_note' => 'أدخل رقم الطلب والهاتف المسجّل على ذلك الطلب هنا؛ يجب أن يطابقا سجّلنا وإلا لن يُرسل رابط البريد.',
            'register_placeholder_email' => 'your@email.com',
        ...
        'fil' => [
            ...
            'track_identity_explain' => 'Sa ibaba: tingnan lang ang status ng order. Para mag-register ng email at i-update ang detalye, gamitin ang sign-up box sa itaas at ilagay doon ang order number at telepono.',
            'track_signup_identity_note' => 'Ilagay dito ang order number at telepono na nasa order; dapat tumugma sa record o tatanggihan ang email request.',
            'register_placeholder_email' => 'your@email.com',
        ...
        'hi' => [
            ...
            'track_identity_explain' => 'नीचे के फ़ील्ड सिर्फ ऑर्डर की स्थिति देखने के लिए हैं। ईमेल पंजीकरण और विवरण अपडेट के लिए ऊपर वाला साइन-अप बॉक्स इस्तेमाल करें।',
            'track_signup_identity_note' => 'यहाँ ऑर्डर नंबर और उस ऑर्डर का फ़ोन दें; रिकॉर्ड से मेल ज़रूरी है, वरना ईमेल लिंक नहीं भेजा जाएगा।',
            'register_placeholder_email' => 'your@email.com',
