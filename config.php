...
function get_translations(): array {
    return [
        'en' => [
            ...
            'cart_guest_orders_empty' => 'No orders yet. Create an account to track all your orders right here — and join our loyalty program to earn points on every purchase and redeem them on your next orders.',
        ...
        'ar' => [
            ...
            'cart_guest_orders_empty' => 'لا توجد طلبات بعد. سجّل حسابك لتتابع جميع طلباتك من هنا، وتنضمّ إلى برنامج الولاء: اجمع نقاطاً مع كل عملية شراء واستخدمها في مشترياتك القادمة.',
        ...
        'fil' => [
            ...
            'cart_guest_orders_empty' => 'Wala pang order. Gumawa ng account para subaybayan dito ang lahat ng order mo — at sumali sa loyalty program para kumita ng points sa bawat bili at gamitin ang mga ito sa susunod mong order.',
        ...
        'hi' => [
            ...
            'cart_guest_orders_empty' => 'अभी कोई ऑर्डर नहीं। अपना अकाउंट बनाएं ताकि आप अपने सभी ऑर्डर यहीं ट्रैक कर सकें — और लॉयल्टी प्रोग्राम से जुड़ें: हर खरीद पर पॉइंट कमाएं और उन्हें अगली खरीद में इस्तेमाल करें।',
