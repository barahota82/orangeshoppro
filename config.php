...
function get_translations(): array {
    return [
        'en' => [
            ...
            'track_signup_cta_text' => 'Sign up now to get updates on your orders, latest offers, and prices… Stay on top of what is new.',
            ...
            'track_signup_order_required' => 'Fill in the order number and phone in the section below first.',
            'track_signup_order_mismatch' => 'These details do not match an order. Check the number and phone below.',
            'track_identity_explain' => 'To view your order or update your email and details, the order number and phone below must match the order on file. The site verifies this automatically when you submit.',
            'track_signup_identity_note' => 'Sending the email link uses the order number and phone from the section below. They must match your order or the request will be rejected.',
        ...
        'ar' => [
            ...
            'track_signup_cta_text' => 'سجّل الآن ليصلك تحديثات طلباتك وآخر العروض والأسعار… كن على اطلاع دائماً بما هو جديد.',
            ...
            'track_signup_order_required' => 'املأ رقم الطلب والهاتف في القسم أدناه أولاً.',
            'track_signup_order_mismatch' => 'لا يطابق هذا الطلب البيانات. تحقق من الرقم والهاتف أدناه.',
            'track_identity_explain' => 'لمتابعة الطلب أو تحديث البريد والبيانات، يجب أن يطابق رقم الطلب والهاتف أدناه ما هو مسجّل على ذلك الطلب. يتحقق الموقع من ذلك تلقائياً عند الإرسال.',
            'track_signup_identity_note' => 'إرسال رابط البريد يعتمد على رقم الطلب والهاتف في القسم أدناه؛ لا يُقبل الطلب إن لم يطابقا بيانات الطلب المسجّلة.',
            'register_placeholder_email' => 'your@email.com',
        ...
        'fil' => [
            ...
            'track_signup_cta_text' => 'Mag-sign up na para sa updates sa orders, latest offers, at presyo… Laging updated sa bago.',
            ...
            'track_signup_order_required' => 'Ilagay muna ang order number at telepono sa ibaba.',
            'track_signup_order_mismatch' => 'Hindi tumutugma. Suriin ang numero at telepono sa ibaba.',
            'track_identity_explain' => 'Para makita ang order o i-update ang email at detalye, dapat tumugma ang order number at telepono sa ibaba sa record ng order. Sinusuri ito ng site kapag nag-submit.',
            'track_signup_identity_note' => 'Ang email link ay gumagamit ng order number at telepono sa ibaba. Dapat tumugma sa order; kung hindi, tatanggihan.',
            'register_placeholder_email' => 'your@email.com',
        ...
        'hi' => [
            ...
            'track_signup_cta_text' => 'अभी साइन अप करें — ऑर्डर अपडेट, नवीनतम ऑफ़र और कीमतें… नए की जानकारी हमेशा रखें।',
            ...
            'track_signup_order_required' => 'पहले नीचे ऑर्डर नंबर और फ़ोन भरें।',
            'track_signup_order_mismatch' => 'मेल नहीं खाता। नीचे नंबर और फ़ोन जाँचें।',
            'track_identity_explain' => 'ऑर्डर देखने या ईमेल/विवरण अपडेट के लिए नीचे का ऑर्डर नंबर और फ़ोन रिकॉर्ड से मेल खाना चाहिए। सबमिट पर साइट इसकी जाँच करती है।',
            'track_signup_identity_note' => 'ईमेल लिंक के लिए नीचे वाला ऑर्डर नंबर और फ़ोन इस्तेमाल होता है। ऑर्डर से मेल न होने पर अनुरोध अस्वीकार होगा।',
            'register_placeholder_email' => 'your@email.com',
