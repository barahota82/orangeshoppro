...
function get_translations(): array {
    return [
        'en' => [
            ...
            'register_placeholder_phone' => 'National number only (after choosing country), or pick International and type full +number',
            ...
            'phone_field_hint' => 'Pick country above, then national digits only. Or choose International and type the full number with + or 00.',
        ...
        'ar' => [
            ...
            'register_placeholder_phone' => 'الرقم الوطني فقط (بعد اختيار الدولة)، أو «دولي» ثم الرقم كاملاً بـ +',
        ...
        'fil' => [
            ...
            'register_placeholder_phone' => 'Pambansang numero (pagkatapos pumili ng bansa), o International + buong numero',
            ...
            'phone_country_in' => 'India +91',
            'phone_country_pk' => 'Pakistan +92',
            'phone_number_label' => 'Numero ng mobile',
            'phone_field_hint' => 'Pumili ng bansa sa listahan, pagkatapos ang pambansang digit (walang +). O International at buong numero na may + o 00.',
            'customer_email' => 'Email',
            'order_number' => 'Order Number',
        ...
        'hi' => [
            ...
            'register_placeholder_phone' => 'केवल राष्ट्रीय नंबर (पहले देश चुनें), या अंतर्राष्ट्रीय + पूरा नंबर',
            ...
            'phone_number_label' => 'मोबाइल नंबर',
