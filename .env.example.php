...
return [
    ...
    // أصل الموقع العام المصرّح به (بدون شرطة أخيرة). تستخدمه الروابط المطلقة:
    // canonical / Open Graph / بريد التأكيد / QR / عودة الدفع.
    // إن غاب أو فُرغ: فشل مغلق — لا يُشتق الأصل من Host الطلب.
