...
<head>
    ...
    <script src="<?php echo htmlspecialchars(storefront_public_path(admin_asset_url('/admin/assets/admin-confirm-actions.js')), ENT_QUOTES, 'UTF-8'); ?>" defer></script>
</head>
<body>
            ...
            $navSalesPromotions = [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['page' => 'offers', 'href' => '/admin/index.php?page=offers', 'label' => 'عروض المنتجات', 'class' => 'admin-nav-sub', 'sub' => true],
            ...
            $navSettings = [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['page' => 'brand_identity', 'href' => '/admin/index.php?page=brand_identity', 'label' => 'هوية العلامة', 'class' => '', 'sub' => false],
