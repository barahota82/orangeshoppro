                    ...
                    <td class="cd-row-ops">
                        <div class="cd-ops-wrap">
                            <div class="cd-ops-arrows">
                                <button type="button" class="btn-secondary cd-btn-reorder" onclick="moveColorRow(this,'up')">↑</button>
                                <button type="button" class="btn-secondary cd-btn-reorder" onclick="moveColorRow(this,'down')">↓</button>
                            </div>
