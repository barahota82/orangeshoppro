...
<div class="page-title page-title--stacked">
    ...
    <p class="page-subtitle">ثلاث جمل تتناوب في الـ hero حسب لغة الزائر. إن كانت الجمل الثلاث فارغة لذات اللغة (العمود) يُعرض النص الافتراضي من ملف الترجمة لتلك اللغة.</p>
</div>
