...
$gamReportTodayYmd = '';
try {
    $gamReportDefaults = orange_admin_time_report_default_from_to_for_admin_context($pdo);
    $gamReportTimeIana = (string) $gamReportDefaults['iana'];
    $gamReportTodayYmd = (string) $gamReportDefaults['to_ymd'];
} catch (Throwable $e) {
    $gamReportTimeIana = '';
}
...
$yNow = $gamReportTodayYmd !== '' ? (int) substr($gamReportTodayYmd, 0, 4) : (int) gmdate('Y');
$mNow = $gamReportTodayYmd !== '' ? (int) substr($gamReportTodayYmd, 5, 2) : (int) gmdate('n');
...
$todayDmY = $gamReportTodayYmd !== ''
    ? orange_format_date_dmY($gamReportTodayYmd)
    : orange_format_date_dmY(gmdate('Y-m-d'));
$printDatetime = $gamReportTimeIana !== ''
