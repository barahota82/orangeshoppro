                    ...
                    <td class="cat-row-ops">
                        <div class="cat-ops-wrap">
                            <div class="cat-ops-arrows">
                                <button type="button" class="btn-secondary cat-btn-reorder" onclick="moveCategoryRow(this,'up')" aria-label="أعلى">↑</button>
                                <button type="button" class="btn-secondary cat-btn-reorder" onclick="moveCategoryRow(this,'down')" aria-label="أسفل">↓</button>
                            </div>
