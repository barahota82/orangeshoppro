...
<div class="page-title page-title--stacked">
    <div>
        <h1>فاتورة شراء</h1>
        <p class="page-subtitle">تسجيل مشتريات نقدي أو آجل؛ <strong>حفظ الفاتورة لا يزيد المخزون</strong> — يزيد مخزون <strong>المتغير</strong> عند <strong>استلام البضاعة</strong>. قيد الحفظ يُثبت المبلغ على حساب <strong>مشتريات قيد الاستلام (GRNI)</strong> ثم عند الاستلام يُرحَّل إلى <strong>المخزون</strong> (اربط الحساب من «حسابات القيود التلقائية»). مردود المشتريات كما هو عبر شاشة مردود المشتريات.</p>
    </div>
</div>
