                    ...
                    <td class="sf-row-ops">
                        <div class="sf-ops-wrap">
                            <div class="sf-ops-arrows">
                                <button type="button" class="btn-secondary sf-btn-reorder" onclick="moveFamilyRow(this,'up')">↑</button>
                                <button type="button" class="btn-secondary sf-btn-reorder" onclick="moveFamilyRow(this,'down')">↓</button>
                            </div>
