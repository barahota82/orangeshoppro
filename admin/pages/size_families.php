...
<div class="page-title">
    ...
    <p class="page-subtitle" style="margin:0.35rem 0 0;font-size:0.95rem;color:#555;line-height:1.5;">هرَم المقاس وفق سياسة المشروع: <strong>نوع تجاري</strong> (<code>commercial_kind_key</code>) ← <strong>فئة القياس</strong> (<code>sizing_category_key</code>) ← <strong>مخطّط العائلة</strong> (<code>size_scheme_key</code>) ← قيم القائمة في <code>size_family_sizes</code>. مرجعية اختيارية للمستويين 1–2: جدايل <code>commercial_kind_dictionary</code> و<code>sizing_category_dictionary</code> (تُنشأ مع المخطط) لربط المفاتيح بعناوين عرض دون تكرار شجرة التنقّل. عند ضبط <code>expected_size_scheme_key</code> على <a href="<?php echo htmlspecialchars(storefront_public_path('/admin/index.php?page=product_types'), ENT_QUOTES, 'UTF-8'); ?>">نوع منتج موحّد</a>، يُطبَّق تحقّق المطابقة تلقائياً مع حقلي المستويين الأولين على العائلة.</p>
</div>
