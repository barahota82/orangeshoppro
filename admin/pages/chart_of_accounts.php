    ...
    <div class="coa-shell__body" dir="ltr">
        <aside class="coa-shell__tree card coa-tree-card">
            ...
            <div class="coa-tree-scroll" id="coa_tree_root" role="tree">
                <?php if ($tree === []): ?>
                    <p class="muted">
                        لا توجد حسابات في القاعدة. عند أول تشغيل على قاعدة فارغة يُنشأ النظام تلقائياً سبعة جذور (أصول، خصوم، حقوق ملكية، إيرادات، تكلفة مبيعات، مصروفات، حسابات تحليلية) بترميز UTF-8.
