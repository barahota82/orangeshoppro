...
(function () {
    ...
    function rowHtml(ln, idx) {
        ...
        return '<tr data-idx="' + idx + '">'
            ...
            + '<td><input type="number" class="admin-inp-qty stk-add" min="0" step="1" inputmode="numeric" lang="en" dir="ltr" placeholder="0" value="' + ((parseInt(ln.qty_add, 10) || 0) > 0 ? ln.qty_add : '') + '"' + dis + '></td>'
            + '<td><input type="number" class="admin-inp-qty stk-deduct" min="0" step="1" inputmode="numeric" lang="en" dir="ltr" placeholder="0" value="' + ((parseInt(ln.qty_deduct, 10) || 0) > 0 ? ln.qty_deduct : '') + '"' + dis + '></td>'
