...
$taReportTodayYmd = '';
try {
    $taReportDefaults = orange_admin_time_report_default_from_to_for_admin_context($pdo);
    $taReportTimeIana = (string) $taReportDefaults['iana'];
    $taReportTodayYmd = (string) $taReportDefaults['to_ymd'];
} catch (Throwable $e) {
    $taReportTimeIana = '';
}
...
$yNow = $taReportTodayYmd !== '' ? (int) substr($taReportTodayYmd, 0, 4) : (int) gmdate('Y');
$mNow = $taReportTodayYmd !== '' ? (int) substr($taReportTodayYmd, 5, 2) : (int) gmdate('n');
...
$todayDmY = $taReportTodayYmd !== ''
    ? orange_format_date_dmY($taReportTodayYmd)
    : orange_format_date_dmY(gmdate('Y-m-d'));
$printDatetime = $taReportTimeIana !== ''
