...
.rc-guide-actions{display:flex;flex-wrap:wrap;align-items:center;gap:10px;width:100%}
...
/* Cancel opposite primary on the same action row (Owner 2026-07-24) — outlined, never stronger than primary */
.rc-guide-cancel{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin-inline-start:auto}
...
.rc-guide-cancel .rc-fw-cancel,.rc-guide-cancel .btn-link.rc-fw-cancel{
    ...
    -webkit-text-fill-color:#334155;font-weight:600;font:inherit;font-size:.92rem;cursor:pointer;text-decoration:none
}
    ...
    <div class="rc-wizard" id="rc_guided_root">
        ...
        <div class="rc-wizard-main">
            <section class="rc-wizard-hero" id="rc_guide_now" aria-live="polite">
                ...
                <div class="rc-guide-actions" id="rc_guide_actions">
...
(function () {
    ...
    function renderGuidedWorkflow() {
        ...
        // Expose framework job cancel on the wizard action row only while job.cancellable (Owner 2026-07-24).
        // Reuses existing rc-fw-cancel → job/cancel.php + confirm — no new cancellation path.
