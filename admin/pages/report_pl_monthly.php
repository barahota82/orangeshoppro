        ...
        <form method="get" class="gas-acc-stmt-filter-form" id="pl_m_form">
            ...
            <div class="gas-acc-stmt-toolbar-wrap">
                <div class="gas-acc-stmt-toolbar ta-report-toolbar ta-report-toolbar--pl-monthly-filters gas-acc-stmt-toolbar--main-center">
                    ...
                    <label class="gas-acc-stmt-field pl-monthly-show-zeros-field" style="display:flex;align-items:center;gap:0.5rem;margin:0;align-self:flex-start;white-space:nowrap;">
                    ...
                    <label class="gas-acc-stmt-field is-ignore-close-field" style="align-self:flex-start;" title="قيود الإقفال السنوي (YEC) تُصفّر الإيرادات والمصروفات — فعِّل هذا الخيار لاستبعادها من أرقام التقرير إذا كان المدى الزمني يشمل تاريخ الإقفال.">
