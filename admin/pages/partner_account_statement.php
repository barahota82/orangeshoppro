...
<div class="admin-fy-shell" dir="rtl">
    <div class="gl-acc-stmt-no-print">
        ...
        <p class="admin-fy-shell__lead">اختر حساباً من الدليل وحدد الفترة — يعتمد على سندات اليومية.</p>
    </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($rows as $sr): ?>
                            <tr>
                                ...
                                <td dir="ltr" style="text-align:right;"><?php echo htmlspecialchars(orange_partner_account_stmt_gl_voucher_display($sr), ENT_QUOTES, 'UTF-8'); ?></td>
