...
<div class="card gl-auto-form-card" style="margin-top:1rem;">
        ...
        <p class="card-hint" style="margin:0 0 0.75rem;max-width:52rem;line-height:1.55;">
            ...
            أما <strong>تسليم الطلب النقدي أو الأونلاين</strong> فيُربَط من <strong>الجزء الأول</strong> ببنود
            <strong>العملاء النقدي / العملاء أونلاين</strong> و<strong>إيراد المبيعات</strong> المناسب و<strong>الخزينة</strong> (قيد بأربعة أسطر)، وليس من صف CSI/OSI في الجدول أدناه.
