...
<div class="card gl-auto-form-card" style="margin-top:1rem;">
        ...
        <p class="card-hint" style="margin:0 0 0.75rem;max-width:52rem;line-height:1.55;">
            ...
            أما <strong>تسليم الطلب النقدي</strong> فيُربَط محاسبياً من <strong>الجزء الأول</strong> ببنود
            <strong>العملاء النقدي</strong> و<strong>إيراد المبيعات النقدية</strong> و<strong>الخزينة</strong> (قيد بأربعة أسطر في الترحيل)، وليس من صف CSI في الجدول أدناه.
