...
try {
    ...
    $payload = orange_restore_admin_fw_cutover_readiness(
        $ctx['work_root'],
        $mayFull,
        $mayCountry,
        $jobId
    ...
    json_response([
        ...
        'smoke_report' => $payload['smoke_report'] ?? null,
        'status_label_ar' => (string) ($payload['status_label_ar'] ?? ''),
        'warning' => (string) ($payload['warning'] ?? 'لم يتم تعديل قاعدة الإنتاج أو ملفات الإنتاج، ولا يزال التحويل إلى الإنتاج غير مسموح.'),
    ]);
} catch (Throwable $e) {
